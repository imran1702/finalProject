...
const Pagination = ({next, prev, allPage, currentPage}) => {
        ...
        <>
            <nav className="flex items-center gap-x-1" aria-label="Pagination">
                ...
                <div className="flex items-center gap-x-1">
                    ...
                    <span className="min-h-9.5 flex justify-center items-center text-gray-500 py-2 px-1.5 text-sm">{allPage.length - 1}</span>
                </div>
