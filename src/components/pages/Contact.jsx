    ...
    <div class="max-w-6xl max-lg:max-w-3xl mx-auto bg-white p-4">
      <div
          ...
          <ul class="mt-4 flex flex-wrap justify-center gap-6">
            <li class="flex items-center text-blue-600">
              ...
              <a href="javascript:void(0)" class="text-sm ml-3">
                <span class="font-medium">arfozian@gmail.com</span>
              </a>
            </li>
            <li class="flex items-center text-blue-600">
              <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='currentColor'
              ...
              <a href="javascript:void(0)" class="text-sm ml-3">
                <span class="font-medium">+8801626-681923</span>
              </a>
            </li>
          </ul>
        </div>
        ...
        <div class="z-10 relative h-full max-lg:min-h-[350px]">
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d269.46634525913043!2d90.38024268073251!3d23.719690108156968!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8dea7c18969%3A0xc4c2a51658e86152!2sLalbagh%2C%20Dhaka!5e1!3m2!1sen!2sbd!4v1760596823373!5m2!1sen!2sbd"
